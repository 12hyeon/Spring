...
import jpabook.jpashop.domain.status.jpashop.domain.status.OrderStatus;
...
/*    public void setGiftBox(GiftBox giftBox) {
    ...
    //==생성 메서드==//
    public static Order createOrder(Member member, Delivery delivery, Member member2, OrderItem... orderItems) {
